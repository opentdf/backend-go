...
const (
	AccessService_Info_FullMethodName            = "/opentdf.platform.access.AccessService/Info"
	AccessService_PublicKey_FullMethodName       = "/opentdf.platform.access.AccessService/PublicKey"
	AccessService_LegacyPublicKey_FullMethodName = "/opentdf.platform.access.AccessService/LegacyPublicKey"
	AccessService_Rewrap_FullMethodName          = "/opentdf.platform.access.AccessService/Rewrap"
)
...
var AccessService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "opentdf.platform.access.AccessService",
